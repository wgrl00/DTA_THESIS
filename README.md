...
The final experiment-ready dataset contains the processed and masked response text, multi-label annotations, project information, and the predefined dataset split.
